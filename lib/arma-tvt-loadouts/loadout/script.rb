  ...
  module TvT
    module Loadouts
      class Script
        ...
        #include ::ArmA::TvT::Loadouts::Config::Configured
...
TEMPLATE_LOADOUTS
          ...
          loadoutManager = ArmA::TvT::Loadouts::InfantryManager.new
          values = {}
        ...
        def get_script_path
          File.join(config['mission-directory'.to_sym], 'arma-tvt-loadouts', 'infantry_loadouts', 'generated_loadouts.sqf').to_s
        end
      end
    end
  end
