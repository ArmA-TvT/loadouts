...
describe ::ArmA::TvT::Loadouts::InfantryManager, '#get_quantified_item' do
...
describe ::ArmA::TvT::Loadouts::InfantryManager, '#sanitize_array' do
...
describe ::ArmA::TvT::Loadouts::InfantryManager, '#merge_loadouts' do
