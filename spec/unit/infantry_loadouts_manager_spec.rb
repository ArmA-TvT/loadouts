...
describe ArmA::TvT::Loadouts::InfantryManager, '#process' do
...
describe ArmA::TvT::Loadouts::InfantryManager , '#get_MTK_class' do
  ...
  it 'should return the right TVTMTK Class name' do
    sqmFiles.each { |sqmFile|
      subject.load(
          blue_classes: File.expand_path('../../../data/classes/bluefor.classes.yml', __FILE__),
          red_classes: File.expand_path('../../../data/classes/redfor.classes.yml', __FILE__),
...
describe ArmA::TvT::Loadouts::InfantryManager, '#add_quantified_item' do

  it 'should parse quantified items' do
    expect(subject.send(:add_quantified_item,
                        'addItemToUniform',
                        '3x ACE_fieldDressing')).to eq('[this,3,"ACE_fieldDressing"] call tvtmtk_fnc_addItemToUniform;')
    expect(subject.send(:add_quantified_item,
                        'addItemToVest',
                        'ACE_fieldDressing')).to eq('[this,1,"ACE_fieldDressing"] call tvtmtk_fnc_addItemToVest;')
    expect(subject.send(:add_quantified_item,
                        'addItem',
                        'ACE_fieldDressing')).to eq('[this,1,"ACE_fieldDressing"] call tvtmtk_fnc_addItem;')

  end
end


describe ArmA::TvT::Loadouts::InfantryManager , '#remove_all' do
...
describe ArmA::TvT::Loadouts::InfantryManager , '#addGears' do
...
describe ArmA::TvT::Loadouts::InfantryManager , '#addWeapons' do
  ...
  it 'should add infantry' do
    ...
    expect(subject.send(:add_weapons, 'cdc', 'WEST')).to eq('[this,1,"rhs_mag_30Rnd_556x45_M855A1_Stanag"] call tvtmtk_fnc_addItem;this addWeapon "rhs_weap_m4a1_grip";this addPrimaryWeaponItem "rhsusf_acc_ACOG3";[this,1,"rhsusf_mag_7x45acp_MHP"] call tvtmtk_fnc_addItem;this addWeapon "rhsusf_weap_m1911a1";this addWeapon "Binocular";[this,6,"ACE_fieldDressing"] call tvtmtk_fnc_addItem;[this,2,"ACE_morphine"] call tvtmtk_fnc_addItem;[this,2,"rhs_mag_m67"] call tvtmtk_fnc_addItem;[this,2,"SmokeShell"] call tvtmtk_fnc_addItem;[this,1,"ACE_EarPlugs"] call tvtmtk_fnc_addItem;this linkItem "ItemMap";this linkItem "ItemCompass";this linkItem "ItemRadio";this linkItem "tf_microdagr";[this,9,"rhs_mag_30Rnd_556x45_M855A1_Stanag"] call tvtmtk_fnc_addItem;[this,2,"rhsusf_mag_7x45acp_MHP"] call tvtmtk_fnc_addItem;[this,4,"rhs_mag_m67"] call tvtmtk_fnc_addItem;[this,4,"SmokeShell"] call tvtmtk_fnc_addItem;[this,1,"ACE_MapTools"] call tvtmtk_fnc_addItem;[this,1,"ACE_microDAGR"] call tvtmtk_fnc_addItem;')
    expect(subject.send(:add_weapons, 'recon', 'WEST')).to eq('[this,1,"rhs_mag_30Rnd_556x45_M855A1_Stanag"] call tvtmtk_fnc_addItem;this addWeapon "rhs_weap_m4a1_grip";this addPrimaryWeaponItem "rhsusf_acc_ACOG3";this addWeapon "ACE_Yardage450";[this,6,"ACE_fieldDressing"] call tvtmtk_fnc_addItem;[this,2,"ACE_morphine"] call tvtmtk_fnc_addItem;[this,2,"rhs_mag_m67"] call tvtmtk_fnc_addItem;[this,2,"SmokeShell"] call tvtmtk_fnc_addItem;[this,1,"ACE_EarPlugs"] call tvtmtk_fnc_addItem;this linkItem "ItemMap";this linkItem "ItemCompass";this linkItem "ItemRadio";this linkItem "tf_microdagr";[this,9,"rhs_mag_30Rnd_556x45_M855A1_Stanag"] call tvtmtk_fnc_addItem;[this,4,"rhs_mag_m67"] call tvtmtk_fnc_addItem;[this,4,"SmokeShell"] call tvtmtk_fnc_addItem;[this,1,"ACE_MapTools"] call tvtmtk_fnc_addItem;[this,1,"ACE_microDAGR"] call tvtmtk_fnc_addItem;')
  end
end
